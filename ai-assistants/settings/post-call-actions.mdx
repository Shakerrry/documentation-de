...
<AccordionGroup>
  ...
  <Accordion title="Webhook-URL" icon="link">
    ...
    **Beispiel:** `https://automate.autocalls.ai/api/v1/webhooks/your-webhook-id`
...
```json
{
  ...
  "transcript": [
    {
      "text": "Hallo! Hier ist Sarah von Autocalls.",
      "type": "transcript",
      "sender": "bot",
  ...
  "formatted_transcript": "KI: Hallo! Hier ist Sarah von Autocalls.\\nKunde: Hallo, mir geht es gut, danke.",
